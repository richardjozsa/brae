...
__device__ inline void wallProductionG0(int c, int wf, scalar y, scalar dc, scalar kc, scalar invNwC,
        const scalar* wux, const scalar* wuy, const scalar* wuz, const scalar* Ux, const scalar* Uy, const scalar* Uz,
        scalar nu, scalar yplLam, scalar Cmu25, scalar kappa, scalar E, scalar* G0) {
...
std::vector<scalar> nutkWallFunction(const FvPatch& wall,
                                     ...
                                     scalar nu,
                                     scalar Cmu = 0.09, scalar kappa = 0.41, scalar E = 9.8);
